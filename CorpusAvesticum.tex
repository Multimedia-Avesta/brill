...
\newcommand*{\PGmc}[2][]{%
   ...
   \resetlanguage}
\newif\if@PhlNoEmph   
\def\Phl{\@ifstar{\@PhlNoEmphtrue\@Phl}{\@PhlNoEmphfalse\@Phl}}
\newcommand*{\@Phl}[2][]{%
...
\newcommand*{\@@Phl}[3][]{%
   ...
   \else%
      \textit{#2}%
      \ifstrempty{#3}{}{\ \textlangle{}#3\textrangle{}}%
   \fi%
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage
   \@ifnextchar ,{}{\@ifnextchar .{}{\ }}}
...
\newenvironment{ShugniBlock}{\def\indexlanguage{Shugni}\renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newenvironment{TochABlock}{\def\indexlanguage{Tocharian A}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{TochBBlock}{\def\indexlanguage{Tocharian B}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
