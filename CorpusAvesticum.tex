\ProvidesFile{CorpusAvesticum.tex}[2019/12/09 v0.18.0 Configuration file for 
brill]
...
\gdef\@@sequenceofletters{}
%%\AtBeginEnvironment{ModDictionary}{\gdef\@@sequenceofletters{}}
\AfterEndEnvironment{ModDictionary}{%
...
\newcommand{\@addtosequenceofletters}[1]{%
   ...
   \ifdefstrequal{\@initialletter}{-}
      {\StrLeft{\@initialletter}{1}[\@initialletter]}%
...
\newcommand{\Sequenceofletters}{Sequence of letters:\\%
   \@sequenceofletters\gdef\@@sequenceofletters{}%
