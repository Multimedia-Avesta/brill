\ProvidesFile{CorpusAvesticum.tex}[2020/04/08 v0.31.0 Configuration file for
brill]
   ...
   \begin{titlepage}
      ...
      \begin{center}
        ...
        \IfFileExists{\@titlelogofile}%
           {\includegraphics{\@titlelogofile}\par\vspace*{\baselineskip}}%
           {}
        {\normalsize\scshape LEIDEN\ |\ BOSTON\par}%
      \end{center}\removelastskip%
      \if@PhD\else
         \next@tpage
