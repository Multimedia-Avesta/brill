\ProvidesFile{CorpusAvesticum.tex}[2020/02/17 v0.24.0 Configuration file for
brill]
...
\newcommand*{\@@Phl}[3][]{%
   ...
   \else%
      ...
      \ifstrempty{#3}{}{\unskip\ \textlangle{}#3\textrangle{}}%
   \fi%
   \ifstrempty{#1}{}{\unskip\ \enquote{#1}}%
   \resetlanguage%
   \xspace%
