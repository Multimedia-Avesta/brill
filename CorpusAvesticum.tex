...
\newcommand{\@rd}[1]{%TODO: Spacing
   ...
   \fi%
   \hangindent\parindent\hangafter=1\relax%
   \settoggle{@stanzalinenumbers}{true}%TODO: Check
   \ignorespaces%
}
...
\newcommand{\@GetstanzaTextonly}[2][]{%
   \setkeys{stanza}{heading=\@defaultstanzaheading,#1}%
   \iftoggle{@stanzalinenumbers}{\setcounter{linenumberforstanza}{0}}{}%
   \ifcsdef{stanza-#2}%
      {%
         \begingroup%
            \let\app\@gobble%
      ...
      {%
         \ClassError{brill}{Stanza `#2` could not be read}%
            {There is no macro for stanza `#2`}%
      }%
}
...
\newcommand{\@@Gettranslation}[2][]{%
   ...
   \iftoggle{@translationlinenumbers}{\setcounter{linenumberforstanza}{0}}{}%
...
\newcommand{\RDTrans}[1]{%
   \settoggle{@translationlinenumbers}{false}%
   {\itshape #1}%
   \settoggle{@translationlinenumbers}{true}%
}%
%
\let\@abstract\@empty%
\ifbrill@PhD
