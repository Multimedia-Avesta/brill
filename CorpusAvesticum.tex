...
\newcommand{\ItalicsOrNot}[1]{%
   \IfStrEqCase{#1}{%
      ...
      {Chor}{\def\indexlanguage{G@Choresmian}\itshape}%
      ...
      {IMP}{\def\indexlanguage{Z@Inscriptional Middle Persian}\itshape}%
      {IParth}{\def\indexlanguage{Z@Inscriptional Parthian}\itshape}%
      {Khot}{\def\indexlanguage{H@Khotanese}\itshape}%
      {Lat}{\def\indexlanguage{N@Latin}\itshape}%
      {MAv}{\def\indexlanguage{N@Middle Avestan}\itshape}
      {MMP}{\def\indexlanguage{N@Manichaean Middle Persian}\itshape}
      {MP}{\def\indexlanguage{N@Middle Persian (unspecified)}\itshape}
      {MParth}{\def\indexlanguage{N@Manichaean Parthian}\itshape}
      {OAv}{\def\indexlanguage{N@Old Avestan}\itshape}
      ...
      {PIE}{\def\indexlanguage{DB@Proto-Indo-European}\itshape}%
      {Pli}{\def\indexlanguage{Q@PāỊi}\itshape}%
      {Pra}{\def\indexlanguage{R@Prakrit}\itshape}%
      {PrIIr}{\def\indexlanguage{P@Proto-Indo-Iranian}\itshape}%
...
%   \resetlanguage}
\newcommand*{\IMP}[2][]{%
   \def\indexlanguage{H@Inscriptional Middle Persian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\IParth}[2][]{%
   \def\indexlanguage{H@Inscriptional Parthian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\Khot}[2][]{%
...
\newcommand*{\MAv}[2][]{%
   ...
   \resetlanguage}
\newcommand*{\MMP}[2][]{%
   \def\indexlanguage{N@Manichaean Middle Persian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\MP}[2][]{%
   \def\indexlanguage{N@Middle Persian (unspecified)}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\MParth}[2][]{%
   \def\indexlanguage{N@Manichaean Parthian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\OAv}[2][]{%
   \def\indexlanguage{N@Old Avestan}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\let\origOE\OE
...
\let\Phlvtlt\Phltlt
\newcommand*{\PIE}[2][]{%
   \def\indexlanguage{R@Proto-Indo-European}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\Pli}[2][]{%
...
\newcommand*{\Pra}[2][]{%
   ...
   \resetlanguage}
\newcommand*{\PrIIr}[2][]{%
   \def\indexlanguage{P@Proto-Indo-Iranian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\PrIr}[2][]{%
...
\newenvironment{ChorBlock}{\def\indexlanguage{G@Choresmian}\renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newenvironment{IMPBlock}{\def\indexlanguage{O@Inscriptional Middle Persian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{IParthBlock}{\def\indexlanguage{L@Inscriptional Parthian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newenvironment{MAvBlock}{%
   \def\indexlanguage{ZZ@Middle Avestan}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{MMPBlock}{%
   \def\indexlanguage{ZZ@Manichaean Middle Persian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{MPBlock}{%
   \def\indexlanguage{ZZ@Middle Persian (unspecified)}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{MParthBlock}{%
   \def\indexlanguage{ZZ@Manichaean Parthian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
\newenvironment{OAvBlock}{%
   \def\indexlanguage{ZZ@Old Avestan}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newenvironment{PIEBlock}{%
   \def\indexlanguage{ZZ@Proto-Indo-European}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newenvironment{PrIIrBlock}{\def\indexlanguage{P@Proto-Indo-Iranian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{}	
\newenvironment{PrIrBlock}{\def\indexlanguage{P@Proto-Iranian}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{}	
...
\newenvironment{SogdBlock}{\def\indexlanguage{J@Sogdian}\renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape}{\resetlanguage}
...
\newcommand*{\AiJphl}[1]{\gls{AiJphl}\nobreakspace{}#1}%
\newcommand*{\AiJpz}[1]{\gls{AiJpz}\nobreakspace{}#1}%
\newcommand*{\AiW}[1]{\gls{AiW}\nobreakspace{}#1}%
\newcommand*{\AM}[1]{\gls{AM}\nobreakspace{}#1}%
\newcommand*{\Ank}[1]{\gls{Ank}\nobreakspace{}#1}% 
\newcommand*{\Aog}[1]{\gls{Aog}\nobreakspace{}#1}% 
\newcommand*{\As}[1]{\gls{As}\nobreakspace{}#1}% Asirvad
\newcommand*{\AV}[1]{\gls{AV}\nobreakspace{}#1}%
\newcommand*{\AWM}[1]{\gls{AWM}\nobreakspace{}#1}%
