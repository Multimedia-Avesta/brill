\ProvidesFile{CorpusAvesticum.tex}[2020/03/11 v0.27.0 Configuration file for
brill]
...
\renewcommand*{\maketitle}[1][1]{%
   ...
   \begin{titlepage}
      ...
      \else
        \next@tdpage\null\vfill
        {\centering{\usekomafont{dedication}{\fontsize{12bp}{13.2bp}\selectfont%
         \@dedication \par}}%
        \vskip 3\baselineskip
        {\fontsize{24bp}{24bp}\selectfont\symbol{"2235}\par}}%
