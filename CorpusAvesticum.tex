\ProvidesFile{CorpusAvesticum.tex}[2020/03/29 v0.28.0 Configuration file for
brill]
...
\renewcommand*{\maketitle}[1][1]{%
   ...
   \begin{titlepage}
      ...
      \begin{center}
        {\normalfont\fontsize{26bp}{36bp}\selectfont\bfseries\hyphenpenalty=10000
         \@title\par}%
        \vskip 2\baselineskip
        {\ifx\@subtitle\@empty\else
         {\normalfont\fontsize{16bp}{20bp}\selectfont\itshape\hyphenpenalty=10000
            \@subtitle\par}\fi%
        }%
        \vskip 2\baselineskip
...
\newcommand*{\Aram}[2][]{%
   \def\indexlanguage{Aramaic}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \emph{\hyphenpenalty=10000\relax#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\Arm}[2][]{%
...
\newcommand*{\@Av}[2][]{%
   ...
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \Word[#2]{\emph{\hyphenpenalty=10000\relax#2}}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\@@Av}[2][]{%
   \def\indexlanguage{Avestan}%
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
...
\newcommand*{\Grk}[2][]{%
   ...
   \renewcommand*{\idxentryfont}[1]{##1}%
   {\hyphenpenalty=10000\relax#2}\ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\Guj}[2][]{%
...
\newcommand*{\@OP}[3][]{%
   ...
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \textit{\hyphenpenalty=10000\relax#2}%
   \ifstrempty{#3}{}{\ [#3]}%
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage
...
\newcommand*{\@Phlreverse}[3][]{%
   ...
   \ifstrempty{#3}
      ...
      {%
         \textlangle{}#3\textrangle{}%
         \ifstrempty{#2}{}{\ \textit{\hyphenpenalty=10000\relax(#2)}}%   
      }%
   % We assume, that #2 and #3 are not both empty
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage%
...
\newcommand*{\Phltlt}[2][]{%
   \def\indexlanguage{Pahlavi}%
   \renewcommand*{\idxentryfont}[1]{##1}%
   \ifstrempty{#2}{}{\hyphenpenalty=10000\relax#2}%
...
\newcommand*{\Sogd}[3][]{%
   ...
   \ifstrempty{#2}
      {/#3/}%
      {%
         \emph{\hyphenpenalty=10000\relax#2}%
         \ifstrempty{#3}{}{\ /#3/}%
      }%
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
...
\newenvironment{PliBlock}{\def\indexlanguage{PāỊi}\renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape\hyphenpenalty=10000\relax}%
   {\resetlanguage}
\newenvironment{PraBlock}{\def\indexlanguage{Prakrit}\renewcommand*{\idxentryfont}[1]{\textit{##1}}\itshape\hyphenpenalty=10000\relax}%
   {\resetlanguage}
