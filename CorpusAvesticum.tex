\ProvidesFile{CorpusAvesticum.tex}[2020/04/28 v0.31.0 Configuration file for
brill]
...
%        {\usekomafont{title}{\fontsize{28bp}{33bp}\selectfont\@title\par}}%
         ...
         %\vspace{\dimexpr .5\baselineskip - \dp\@titlebox\relax}%
         ...
         \else%
            ...
            %\vspace{\dimexpr 0.484848\baselineskip - \dp\@subtitlebox\relax}%
            \vspace*{9.2bp}%
         \fi%
         \prevdepth0pt% 
...
\newcommand{\Lemma}[2][]{\item[#2]\ifstrempty{#1}{}{\ \textlangle{}#1\textrangle{}}}
%\newcommand{\cnt}{}
%\NewEnviron{Lemma}[1]{%
