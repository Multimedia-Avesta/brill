...
\newcommand{\@@indexpassages}[2][]{%
   %\ifdef{\sortentry}{
   %   
   %\Index[passages]{\indexlanguage!\sortentry@#1}\textup{#2}\Index[passages]{\indexlanguage!\sortentry@#1}%
   %   \undef{\sortentry}
   %}{%
      \index[passages]{\indexlanguage!#1@#1}\textup{#2}\index[passages]{\indexlanguage!#1@#1}%
   %}%
}%
