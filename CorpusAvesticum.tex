\ProvidesFile{CorpusAvesticum.tex}[2019/09/02 v0.12.4 Configuration file for 
brill]
...
\newcommand*{\A}[1]{\gls{A}~#1}% Afrinagan
\newcommand*{\ABu}[1]{\gls{ABu}~#1}% Afrin i Buzorgan
\newcommand*{\AD}[1]{\gls{AD}~#1}% Afrin i Dahman
\newcommand*{\AG}[1]{\gls{AG}~#1}% Afrin i Gahambar
\newcommand*{\Ank}[1]{\gls{Ank}~#1}% 
\newcommand*{\As}[1]{\gls{As}~#1}% Asirvad
\newcommand*{\AvAlph}[1]{\gls{AvAlph}~#1}% Avestan alphabet
\newcommand*{\Col}[1]{\gls{Col}~#1}% Colophon
\newcommand*{\DrYt}[1]{\gls{DrYt}~#1}% Drōn Yašt
\newcommand*{\DuP}[1]{\gls{DuP}~#1}% Du&#702;a Paymani
\newcommand*{\FiO}[1]{\gls{FiO}~#1}% Frahang i Oim
\newcommand*{\FrW}[1]{\gls{FrW}~#1}% Fragment Westergard
\newcommand*{\G}[1]{\gls{G}~#1}% Gah
\let\H\@undefined
\newcommand*{\H}[1]{\gls{H}~#1}% Herbedestan
\let\Herbedestan\H
\newcommand*{\Hb}[1]{\gls{Hb}~#1}% Hosbam
\let\HB\Hb
\newcommand*{\HN}[1]{\gls{HN}~#1}% Hadoxt Nask
\newcommand*{\N}[1]{\gls{N}~#1}% Nerangestan
\newcommand*{\NiAb}[1]{\gls{NiAb}~#1}% Nērang-ī āb ud padyāb
\newcommand*{\NiAs}[1]{\gls{NiAs}~#1}% Nirang Asoan
\newcommand*{\Nirang}[1]{\gls{Nirang}~#1}% Nirang
\newcommand*{\NiSY}[1]{\gls{NiSY}~#1}% Nirang Sangriza Yastan
\newcommand*{\NkB}[1]{\gls{NkB}~#1}% Nerang i kustig bastan
\newcommand*{\NS}[1]{\gls{NS}~#1}% Nam Stayisn
\newcommand*{\Ny}[1]{\gls{Ny}~#1}% Nyayisn
\newcommand*{\Par}[1]{\gls{Par}~#1}% Paragna
\newcommand*{\PaIr}[1]{\gls{PaIr}~#1}% Patet Irani
\newcommand*{\PaPas}[1]{\gls{PaPas}~#1}% Patet Pasemanih
\newcommand*{\PaXw}[1]{\gls{PaXw}~#1}% Patet Xwad
\newcommand*{\PazT}[1]{\gls{PazT}~#1}% Pazand texts
\newcommand*{\PPhl}[1]{\gls{PPhl}~#1}% Payman i Pahlawi
\newcommand*{\PS}[1]{\gls{PS}~#1}% Payman i Sanskrit
\let\S\@undefined
\newcommand*{\S}[1]{\gls{S}~#1}% Siroza
\let\Siroza\S
\newcommand*{\SrB}[1]{\gls{SrB}~#1}% Sros Baj
\newcommand*{\Vd}[1]{\gls{Vd}~#1}% Videvdad
\let\V\Vd
\newcommand*{\VN}[1]{\gls{VN}~#1}% Vae&#977;a Nask
\newcommand*{\Vr}[1]{\gls{Vr}~#1}% Visparad
\newcommand*{\VrS}[1]{\gls{VrS}~#1}% Visperad Sade
\newcommand*{\VS}[1]{\gls{VS}~#1}% Videvdad Sade
\newcommand*{\Vyt}[1]{\gls{Vyt}~#1}% Vistasp Yast
\newcommand*{\VytS}[1]{\gls{VytS}~#1}% Vishtasp Yasht Sade
\newcommand*{\Y}[1]{\gls{Y}~#1}% Yasna
\newcommand*{\Yt}[1]{\gls{Yt}~#1}% Yast
\newcommand*{\YiR}[1]{\gls{YiR}~#1}% Yasna ī Rapihwin
\newcommand*{\YVr}[1]{\gls{YVr}~1}% Yasna Visperad
\newcommand*{\Ygah}[1]{\gls{Ygah}~#1}% Yazisn-gah
