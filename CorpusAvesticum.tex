\ProvidesFile{CorpusAvesticum.tex}[2019/07/18 v0.11.2 Configuration file for 
brill]
...
\newcommand{\@@indexpassages}[2][]{%
   \ifdef{\@sortentry}{
      \index[passages]{\@sortentry@\indexlanguage!#1@#1}\textup{#2}\index[passages]{\@sortentry@\indexlanguage!#1@#1}%
      \undef{\@sortentry}
   }{%
...
\newcommand*{\Y}[1]{Y~#1\@makesortentry{#1}}% Yasna
