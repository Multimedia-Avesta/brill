...
\newcommand{\@rd}[1]{%TODO: Spacing
   \settoggle{@setlinenumberforthisline}{false}%
...
\newcommand{\@GetstanzaWithtranslation}[2][]{%
   \if@intextandtranslation
      \paralleltypesetting%
         ...
         {\minisec{\bookstringtocs{#2}}\Gettranslation[linenumbers]{#2}}%
   \else
...
\def\GetstanzasWithtranslations{\@ifstar%
...
\define@key{translation}{linenumbers}[true]{%
   \settoggle{@translationlinenumbers}{#1}}
...
\newcommand{\@@Gettranslation}[2][]{%
   ...
   \iftoggle{@translationlinenumbers}{\setcounter{linenumberforstanza}{1}}{}%
   ...
   \begingroup%
      ...
      \IfStrEqCase{\@rdposition}{%
         ...
         \ifcsdef{translation-#2}%
            {\@checklinenumberstatus\csuse{translation-#2}}%
...
\newcommand{\@checklinenumberstatus}{%
   \if@innumberlines
      \iftoggle{@setlinenumberforthisline}%
         {\immediate\write\@auxout{\csgdef{linenumber-\themuyalinenumber}{}}}%
         {}%
      \ifcsdef{linenumber-\themuyalinenumber}%
         {%
            \marginnote{\thelinenumberforstanza}%
            \refstepcounter{linenumberforstanza}%
         }%
         {}%
      % set variables for next line
      \refstepcounter{muyalinenumber}%
      \settoggle{@setlinenumberforthisline}{true}%
   \fi%
}
