\ProvidesFile{CorpusAvesticum.tex}[2020/05/02 v0.33.0 Configuration file for
brill]
...
\newcommand{\@rdg}[3][]{%
   ...
   \if@subreading
      \ifstrempty{#1}%
         ...
         {\gappto{\@appcr}{\begin{appcrenum}\item[]#1.\hspace{0.5em}}}%
   \fi%
   \@firstwitclasstrue%
...
\setlist{font=\usekomafont{footnotelabel}\scriptsize, nosep, align=left}
\setlist[appcrenum, 1]{label=\arabic*, leftmargin=*}
\setlist[appcrenum, 2]{label=\relax, left=\parindent}
