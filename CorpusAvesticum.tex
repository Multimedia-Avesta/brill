\ProvidesFile{CorpusAvesticum.tex}[2020/05/27 v0.33.2 Configuration file for
brill]
...
\newcommand{\Importstanzas}[1]{%
   \@onlypreamble
   \IfFileExists{#1}%
      {\AtEndPreamble{\directlua{read_stanzas_from_file("\luaescapestring{\unexpanded{#1}}")}}}%
      {\ClassError{brill}{File `#1` could not be found!}{}}%
}

\AfterEndPreamble{%
   \InputIfFileExists{./stanzas.tex}%
      {\ClassInfo{brill}{Stanza macros successfully loaded!}}%
