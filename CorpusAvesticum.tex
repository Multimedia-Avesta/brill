\ProvidesFile{CorpusAvesticum.tex}[2020/07/26 v0.50.0 Configuration file for
brill]
...
\renewcommand*{\maketitle}[1][1]{%
   ...
   {\centering
      ...
      \vskip 3\baselineskip
      \ifx\@degree\@empty\else\@degree\\\fi%
      \@date\par
      \vfill
...
\newcommand*{\@Importstanzas}[2][]{%
   ...
   % An exisiting file from a previous run are currently overwritten.
