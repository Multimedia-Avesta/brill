...
\newcommand{\editedtranslationtext}[1]{\begin{hyphenrules}{nohyphenation}\editedtext{#1}\end{hyphenrules}}
\newcommand{\editedcommentarytext}[1]{\begin{hyphenrules}{nohyphenation}\editedtext{#1}\end{hyphenrules}}
