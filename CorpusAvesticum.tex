...
\ProvidesFile{CorpusAvesticum.tex}%
   [2021/01/26 v0.76.0 Configuration file for brill]
...
\newcommand{\@setlinenumberstatus}{%
   \if@innumberlines
      ...
      \ifboolexpr{ bool {@inrd} or bool {@iscommentarytext} }        
         {}%{\global\settoggle{@setlinenumberforthisline}{false}}%
         {\global\settoggle{@setlinenumberforthisline}{true}}%
   \fi%
}
...
\newcommand{\@getlinenumberstatus}{%
   \if@innumberlines
      \xdef\muyalinenumber{\themuyalinenumber}%
      % If a macro is defined for the current line, i.e. through the aux file 
      % from the previous run by \@setlinenumberstatus, then make a marginal
      % note.
