...
%%
\ProvidesFile{CorpusAvesticum.tex}[2020/08/30 v0.55.0 Configuration file for
brill]
...
\newcommand{\printindexes}{%
   ...
   \begingroup%
      ...
      \printindex[words]%
      %\renewcommand*{\@idxitem}{\removelastskip\par\vspace{\baselineskip}\hangindent 40\p@\relax}%
      \printindex[passages]%
   \endgroup%
...
%   % If \app was called after \editedcommentarytext{}, then close the parentheses now.
%   \if@iscommentarytext
%      \unskip\textit{)}%
%      \@iscommentarytextfalse
%   \fi%
   \@firstrdgtrue%
   \gappto{\@appcr}{\item }#1%
}
      ...
      % be the next footnote number
         ...
         {%
            ...
            \else
               ...
               (% opening parentheses, closing one after last \editedcommentarytext
            \fi%
