\ProvidesFile{CorpusAvesticum.tex}[2020/08/12 v0.53.0 Configuration file for
brill]
...
\newcommand*{\Phltlt}[2][]{%
   \def\indexlanguage{Pahlavi}%
   \renewcommand*{\idxentryfont}[1]{##1}%
   \ifstrempty{#2}{}{\begin{nohyphens}\nosmallcaps\@morewordspace #2\end{nohyphens}}%
...
%   options={--noheadings --config muya}
%   ]%
\newcommand*{\Lemma}[2][]{\item[#2]\@ifnextchar,{}{\ }}
...
\AtEndPreamble{%
   ...
   \InputIfFileExists{\@transcriptionsfile}%
      {\ClassInfo{brill}{Transcriptions successfully loaded!}}%
