...
\newcommand{\@newlanguage}[2]{%
   \expandafter\newcommand\csname #1\endcsname[2][]{%
      ...
      \begin{nohyphens}##2\end{nohyphens}%
...
\newcommand{\@@newlanguage}[2]{%
   \expandafter\newcommand\csname #1\endcsname[2][]{%
      ...
      \begin{nohyphens}\emph{##2}\end{nohyphens}%
      \ifstrempty{##1}{}{\ \enquote{##1}}%
      \resetlanguage} 
   \newenvironment{#1Block}{%
      \def\indexlanguage{#2}%
...
\newcommand*{\@Av}[2][]{%
   ...
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \Word[#2]{\begin{nohyphens}\emph{#2}\end{nohyphens}}%
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage}
\newcommand*{\@@Av}[2][]{%
   \def\indexlanguage{Avestan}%
...
\newcommand*{\@OP}[3][]{%
   ...
   \renewcommand*{\idxentryfont}[1]{\textit{##1}}%
   \begin{nohyphens}\textit{#2}\end{nohyphens}%
   \ifstrempty{#3}{}{\ [#3]}%
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage
...
\newcommand*{\@Phlreverse}[3][]{%
   ...
   \ifstrempty{#3}
      ...
      {%
         \textlangle{}#3\textrangle{}%
         \ifstrempty{#2}{}{\ \begin{nohyphens}\textit{(#2)}\end{nohyphens}}%   
      }%
   % We assume, that #2 and #3 are not both empty
   \ifstrempty{#1}{}{\ \enquote{#1}}%
   \resetlanguage%
...
\newcommand*{\Phltlt}[2][]{%
   \def\indexlanguage{Pahlavi}%
   \renewcommand*{\idxentryfont}[1]{##1}%
   \ifstrempty{#2}{}{\begin{nohyphens}#2\end{nohyphens}}%
...
%%% We define a macro to convert a book string like Y28.1 into a control sequence like \Y{28.1}
