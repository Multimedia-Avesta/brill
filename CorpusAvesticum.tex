\ProvidesFile{CorpusAvesticum.tex}[2019/10/14 v0.13.1 Configuration file for 
brill]
...
\newunicodechar{〈}{{\freeserif\symbol{"2329}}}
\newunicodechar{〉}{{\freeserif\symbol{"232A}}}
...
\ifdef{\textlangle}%
   ...
   {\providecommand*{\textlangle}{〈}}
\ifdef{\textrangle}%
   {\renewcommand*{\textrangle}{〉}}%
   {\providecommand*{\textrangle}{〉}}
