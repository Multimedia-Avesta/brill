\ProvidesFile{CorpusAvesticum.tex}[2020/06/04 v0.40.0 Configuration file for
brill]
...
\renewcommand*{\maketitle}[1][1]{%
   ...
   \begin{titlepage}
      ...
      \ifdimless{\ht\@titlebox}{30bp}{\setlength{\@titleskip}{0pt}}{%
         \ifdimless{\ht\@titlebox}{60bp}{\setlength{\@titleskip}{6.6bp}}{\setlength{\@titleskip}{0pt}}%
      }
      \ifdimless{\ht\@subtitlebox}{20bp}{\setlength{\@titleskip}{0pt}}{%
         \ifdimless{\ht\@subtitlebox}{40bp}{\setlength{\@titleskip}{6.8bp}}{\setlength{\@titleskip}{12.8bp}}%
      }
      ...
      {\centering
         ...
         \else%
            ...
            {%
               \vspace{-2bp}%
               \usekomafont{subtitle}{\fontsize{16bp}{20bp}\selectfont\strut\@subtitle\strut\par\kern-\prevdepth}%
            }%
            \vskip\@subtitleskip%  
         \fi%
         \vskip 3\baselineskip%
        {%
           \vspace{3bp}%
           \normalsize\itshape\strut By\par%
           \kern-\prevdepth%
        }%
        \vskip 1\baselineskip%
        {%
           \fontsize{14bp}{17bp}\selectfont\strut\@author\strut\par%
           \kern-\prevdepth%
        }%
        \vfill
...
\newcommand*{\@newabbreviationac}[4][]{\newabbreviation[type=appcrit,#1]{#2}{#3}{#4}\AtEndDocument{\glsadd{#2}}}
...
\newcommand{\printabbreviationsac}{%
   ...
   \renewcommand{\glossarypreamble}{\vspace*{-\baselineskip}\vspace*{-\parskip}\small}%
   \ifbrill@PhD
...
\newcommand{\Getstanza}[1]{%
   \ifcsdef{stanza-#1}%
      {\csuse{stanza-#1}}%
      {\ClassError{brill}{Stanza `#1` could not be read}{There is no macro for stanza `#1`}}%
}
