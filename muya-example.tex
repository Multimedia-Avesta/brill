...
\documentclass[series=CorpusAvesticum,gitver=true,PhD=true,showgrid=false,colorlinks=true]{brill}
%\directlua{
...
\SetTranslationsFile{../../muya.common/translations.tex}
\SetTitleLogoFile{../../muya.common/BRILL.pdf}
%\Importstanzas{../../muya.redard/muyaSrosDron/latex-apparatus_Y3-8.txt}
%\SetDefaultStanzaheading{\addsec}
%\SetDefaultStanzabooktoindex{false}

\begin{document}
\frontmatter
\title{Ahunauuaitī Gāϑā. Part I: \Av{Tišrō paōiriia} (Yasna 28-30)}
\subtitle{Critical edition and commentary, followed by studies on the transmission and exegetical reception of the text} % comment out if not needed
\author{Benedikt Peschl} % if more than one split with \and
\date{2020}
\department{Department of Religions and Philosophies}
\degree{Thesis submitted for the degree of PhD}
\declarationPhD{}
...
\addsec*{Test}
\addsubsec*{Test}
\cite{schmittEpigraphischexegetischeProblemeAltpersischen1997}
A compound"~word
...
A compound\nbhyphen{}word
%\Av{\passage{\Y{28.1.1-2}}}
%
%\Ved{\passage{\RV{1.104.9b}}} 
%
%\Av{\passage{\Y{45.9.3-4}}}
%
%\Av{\passage*{\Y{22.1-3}}} 
%
%\vspace*{18cm}
%TEST
%\vfill
%\blocktranslation[\Phl{\passage{\WZ{14.3}}}]{Phl}{būd nīšān ī puhlīh ī kunišngarān kū-šān widārgar ī ō wahišt}{There was a sign that there would be a bridge for the \enquote{doers of deeds}, that is, it would lead them to paradise.}
%
%Test
%
%\blocktranslation[\Ved{\passage{\RV{1.1.9c}}}]{Av}{sácasvā naḥ \textbf{svastáye}}{Accompany us \textbf{for (our) well-being!}}
%
%\blocktranslation[\Ved{\passage{\RV{1.104.9b}}}]{Av}{ayáṃ sutás tásya pibā \textbf{mádāya}}{This is it, the pressed (Soma), drink of it \textbf{for (your) exhilaration!}}
%
%\printindexes
%\printbibliography
\end{document}
%\noindent \Y{28.7.1} (Avestan and Pahlavi version)
%
%\blocktranslation{Phl}{\begin{tabular}{@{}llllll@{}}
%      \Av{dāidī} & & \Av{aṣ̌ā} & \Av{tąm} & \Av{aṣ̌īm} & \Av{vaŋhə̄uš āiiaptā manaŋhō}\\
%      dahē & \textbf{-m} & Ašawahišt & ān & tarsagāhīh & ī pad Wahman ābādīh \\
%\end{tabular}}{(Avestan:) Give, O Order, this reward, the boons of Good Thinking. \\ (Pahlavi:) You, O Ašawahišt, give \textbf{to me} that reverence which lies in the prosperity of Wahman.}
%%\vspace{5mm}
%\noindent \Y{28.7.1} (Avestan and Pahlavi version)
%
%\blocktranslation{Phl}{\begin{tabular}{@{}llllll@{}}
...
%\end{tabular}}{(Avestan:) Give, O Order, this reward, the boons of Good Thinking. \\ (Pahlavi:) You, O Ašawahišt, give \textbf{to me} that reverence which lies in the prosperity of Wahman.}
%
%\blocktranslation[\Y{28.7.1} (Avestan and Pahlavi version)]{Phl}{\begin{tabular}{@{}llllll@{}}
%      \Av{dāidī} & & \Av{aṣ̌ā} & \Av{tąm} & \Av{aṣ̌īm} & \Av{vaŋhə̄uš āiiaptā manaŋhō} \\
%      dahē & \textbf{-m} & Ašawahišt & ān & tarsagāhīh & ī pad Wahman ābādīh \\
%\end{tabular}}{(Avestan:) Give, O Order, this reward, the boons of Good Thinking. \\ (Pahlavi:) You, O Ašawahišt, give \textbf{to me} that reverence which lies in the prosperity of Wahman.}
%\Gettranslation{Y3.1}
%\Getstanza{Y3.2}
%\cite{sundermannJungfrauGutenTaten1992} and \cite{schwartzGathicCompositionalHistory2003} and \cite{byrdPhonologyProtoIndoEuropean2017}
%\cite{redardEtudesAvestiquesMazdeennes2013} \cite{lenepveu-hotzEmploiMarRa2016} \cite{ferrer-losillaPresentImparfaitMoyenperse2015} \cite{byrdPhonologyProtoIndoEuropean2017} \cite{humbachGathasZarathushtraOther1991}
%%test \H{3.1} vs. \G{3.1}
%
%Test
%
...
%\glsunset{abbreviation}
%\printabbreviationsac[remove={restorer,altread},add={abbreviation},title={Test y}]
...
\backmatter
%\addchap{Abbreviations for Appa}
\printbibliography
\printabbreviations
\printindexes
\end{document}
